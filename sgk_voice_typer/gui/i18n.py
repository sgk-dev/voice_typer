...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "cfg.tab.audio": {"en": "Microphone", "ru": "Микрофон"},
    ...
    "cfg.sound.classic": {"en": "Classic (C-G)", "ru": "Классика (до-соль)"},
    "cfg.sound.soft": {"en": "Soft (A-E)", "ru": "Мягкий (ля-ми)"},
    "cfg.sound.bright": {"en": "Bright (D-A)", "ru": "Яркий (ре-ля)"},
    "cfg.sound.deep": {"en": "Deep (G-D)", "ru": "Глубокий (соль-ре)"},
    "cfg.sound.crystal": {"en": "Crystal (E-B)", "ru": "Хрустальный (ми-си)"},
    "cfg.sound.warm": {"en": "Warm (F-C)", "ru": "Тёплый (фа-до)"},
